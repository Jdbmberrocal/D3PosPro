...
<div class="width-100 box mb-10">
	<div class="width-50 f-left" align="left">
		@if(!empty(Session::get('business.logo')))
          <img src="{{ asset( 'uploads/business_logos/' . Session::get('business.logo') ) }}" alt="Logo" style="width: auto; max-height:110px; margin: auto;">
        @endif
	</div>
...
<table class="table-pdf">
	<tr>
		...
		<br>
		_______________________________ <br>
		@lang('repair::lang.authorized_signature'):</th>
