	        ...
	        <div class="modal-body">
	            <div class="row">
	            	<div class="col-md-12 text-center">
	            		<a href="{{action([\Modules\Crm\Http\Controllers\ScheduleController::class, 'create'])}}" class="btn btn-success">
			                <i class="fa fa-plus"></i> @lang('crm::lang.add_onetime_follow_up')
			            </a>
			            <a href="{{action([\Modules\Crm\Http\Controllers\ScheduleController::class, 'create'])}}?is_recursive=true" class="btn btn-primary">
