			...
			<div class="box-header with-border">
				<div class="box-tools pull-right">
					@if(auth()->user()->can('crm.add_proposal_template'))
    					<a href="{{action([\Modules\Crm\Http\Controllers\ProposalTemplateController::class, 'getEdit'])}}" class="btn  btn-primary">
    						@lang('messages.edit')
    					</a>
    				@endif
    				@can('crm.access_proposal')
    					<a href="{{action([\Modules\Crm\Http\Controllers\ProposalTemplateController::class, 'send'])}}" class="btn  btn-success">
    						@lang('crm::lang.send')
    					</a>
    				@endcan
				</div>
