		...
		@foreach($medias as $media)
			<tr class="media_row">
				...
				<td>
					...
					<a data-href="{{action([\Modules\Crm\Http\Controllers\ProposalTemplateController::class, 'deleteProposalMedia'], ['id' => $media->id])}}" class="btn btn-danger btn-sm delete_attachment">
