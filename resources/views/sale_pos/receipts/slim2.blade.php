...
<body>
    <div class="ticket">
        ...
        <table style="padding-top: 5px !important" class="border-bottom width-100 table-f-10 mb-10">
            <tbody>
                                        ...
                                        @endif @if (!empty($line['brand']))
                                            ...
                                            @if ($receipt_details->show_base_unit_details && $line['quantity'] && $line['base_unit_multiplier'] !== 1)
                                                <br><small>
                                                    ...
                                                    {{ $line['base_unit_name'] }} <br> {{ $line['quantity'] }} x
                                                    {{ $line['base_unit_multiplier'] }} = {{ $line['orig_quantity'] }}
 ...
 {{-- ESTE ES LA BASE  --}}
    ...
    <div class="textbox-info">
        ...
        Zeus Soluciones Ns - Nit 1091663313-7 <br>
        WhatsApp: 3160402010
    </div>
